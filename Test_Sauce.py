...
class Test_Sauce:
    ...
    @pytest.mark.parametrize("username", ["testtest", "standard_user", "problem_user"])
    ...
    @pytest.mark.parametrize("username, password", [("standard_user", "test"), ("locked_out_user", "123"), ("problem_user", "147258"), ("standard_user", "sauce_secret")])
    ...
    def test_add(self):
        ...
        list = self.driver.find_elements(By.CLASS_NAME, 'inventory_item_name')
        ...
        for item in items:
            ...
            addToCart = item.find_element(By.ID, f'add-to-cart-{list2[i]}')
            addToCart.click()
            i += 1
    ...
    def test_About(self): # about kısmına giriş yapma testi
    ...
    def test_Logout(self): # çıkış yapma testi
